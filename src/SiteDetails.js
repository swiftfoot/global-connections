      ...
      return (
        <div className="siteDetails" style={style}>
              ...
              {this.props.selectedSite.detailImages.map((imageDetails, key) => (
                <div className="imageDetails">
                  <img
                    className="image"
                    draggable="false"
                    key={`imageDetail${this.props.selectedSite.person}${key}`}
                    id={key}
          ...
          <div className="rightDetails" style={initialDetailsStyle}>
            ...
            <img className="separator" src="img/Line-CreamDotted.png" alt="" />
            {
                            this.props.selectedSite.learn_more ? <div className="moreDetailsImage"><img draggable="false" src="img/Button-WantToLearnMore.png" alt="More Details" onTouchStart={this.openMoreDetails.bind(this)} onClick={this.openMoreDetails.bind(this)} /></div> : ''}
